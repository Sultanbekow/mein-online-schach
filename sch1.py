...
class HolzSchachGUI:
    ...
    def create_sidebar_ui(self):
        # Überschrift für die Menüleiste
        ...
        # Styling-Konfiguration für schöne Buttons
        btn_style = {
    ...
    def bind_hover(self, button):
        # Fügt den Buttons einen eleganten Farbeffekt beim Drüberfahren hinzu
    ...
    def action_resign(self):
        # Ermittelt, wer gerade am Zug ist und gibt auf
    ...
    def action_draw(self):
        # Bietet dem anderen Spieler ein Unentschieden an
        current_player = "Weiß" if self.board.turn == chess.WHITE else "Schwarz"
    ...
    def action_undo(self):
        # Nimmt den letzten Zug zurück (falls vorhanden)
